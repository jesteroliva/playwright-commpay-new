...
await page2.locator('div').filter({ hasText: /^Country$/ }).nth(1).click();
  ...
  await page2.getByRole('option', { name: 'SAVINGS' }).click();
  ...
  await expect (page2.getByRole('cell', { name: beneficiaryName })).toBeVisible();


  //EDIT BENEFICIARY
  await page2.getByRole('cell', { name: beneficiaryName, exact: true }).click();
  ...
  //DELETE BENEFICIARY
 // await page2.getByRole('cell', { name: 'test12345' }).click();
  await page2.getByRole('cell', { name: 'test12345' }).click();
